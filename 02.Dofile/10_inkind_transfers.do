...
gen stud_post_sec = (study == 3) & exp_net_SY81 == 0 // we do not have question for paid eductions, so we have to rely on the expenditure info. 
gen stud_tert = inrange(study,4,5) & exp_net_SY82 == 0 // we assume that if hh has education exapnditure, than noone in the hh is on budget funding
